...
def get_initial_state(grid: Grid, background) :
    ...
    df = pd.read_csv("../source/initialdata/output.csv").sort_values("r")
    ...
    #qui aggiungi funzione per catturare alpha e psi dal file csv che ottieni da math
    #get_alpha(csv_data,r) una cosa così 
